...
#define GP4020_CORR_SYSTEM_SETUP    (0x40100000 + 0x1F8)
#define GP4020_CORR_PROG_ACCUM_INT  (0x40100000 + 0x1AC)
#define GP4020_CORR_ACCUM_STATUS_A  (0x40100000 + 0x208)
#define GP4020_CORR_ACCUM_STATUS_B  (0x40100000 + 0x20C)
#define GP4020_CORR_MEAS_STATUS_A   (0x40100000 + 0x204)

// System Setup Register

#define SS_INTERRUPT_ENABLE  (1 << 5)
#define SS_INTERRUPT_PERIOD (1 << 7)
...
#define GPS4020_MPC_A3_DEF  0x0400406E  // 16 bit peripherals (conservative recommendation: 0x3303306E)
